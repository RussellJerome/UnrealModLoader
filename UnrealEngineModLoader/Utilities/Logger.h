...
class LOADER_API Log
{
  private:
    ...
    template <typename... Args> static void LogMsg(MsgType type, const std::string &format, Args &&...args)
    {
  ...
  public:
    ...
    template <typename... Args> static void Print(const std::string &format, Args &&...args)
    {
